...
//*****************************************************************************************************************
        ...
        for _ in 1...Int.random(in: 1..<450) {
            let updateDate = today.subtract(days: Int.random(in: 5..<450))?.string(format: "dd MM yyyy")
...
//*****************************************************************************************************************
        ...
        UITabBar.appearance().barTintColor = UIColor.Blues.lightBlue
